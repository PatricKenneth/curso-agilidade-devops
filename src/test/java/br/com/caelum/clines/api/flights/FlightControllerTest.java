...
class FlightControllerTest {
    ...
    private final LocalDateTime DEFAULT_DATE_TIME = LocalDate
            .parse(DEFAULT_DATE, DateTimeFormatter.ofPattern("dd-MM-yyyy")).atStartOfDay();
    ...
    private final FlightView DEFAULT_FLIGHT_VIEW = new FlightView(1L, BigDecimal.TEN, DEFAULT_WAYPOINT_DEPARTURE,
            DEFAULT_WAYPOINT_ARRIVAL, DEFAULT_AIRCRAFT_VIEW);
